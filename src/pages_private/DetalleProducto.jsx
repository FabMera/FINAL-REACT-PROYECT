...
const DetalleProducto = () => {
  ...
  return (
    <>
    <h1 className="text-center mt-3">Mis Favoritos</h1>
    <hr/>
      <div
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <ul className="list-group list-group-flush">
                    ...
                    {item.estado}
                    <li className="list-group-item">Vendido por : {user}</li>
                    <li className="list-group-item">Descripcion: {item.descrip}</li>
                    <li className="list-group-item">Marcar como Favorito: 
                    <svg style={{cursor:'pointer'}} onClick={()=>onClickHeart(item)} width="40px" viewBox="0 0 24 24">
                  <path
